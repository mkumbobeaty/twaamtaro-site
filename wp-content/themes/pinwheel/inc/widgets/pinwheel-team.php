<?php
if ( ! class_exists( 'Pinwheel_Team' ) ) :

class Pinwheel_Team extends WP_Widget {

	public function __construct() {
		$widget_ops = array('classname' => 'pinwheel_team_widget', 'description' => __( 'Show the Team', 'pinwheel') );
        parent::__construct(false, $name = __('Pinwheel: Team', 'pinwheel'), $widget_ops);
		$this->alt_option_name = 'pinwheel_team_widget';
